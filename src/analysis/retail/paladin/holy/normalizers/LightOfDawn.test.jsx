      ...
      events: [
        {
          ...
          sourceID: 1,
          targetID: null,
          ability: { guid: TALENTS.LIGHT_OF_DAWN_TALENT.id },
          type: EventType.Cast,
        },
        {
          testid: 2,
          ...
          sourceID: 1,
          targetID: 1,
          ability: { guid: SPELLS.LIGHT_OF_DAWN_HEAL.id },
          type: EventType.Heal,
        },
        {
          testid: 3,
    ...
    },
    {
      ...
      events: [
        ...
        },
        {
          ...
          timestamp: 0,
          sourceID: 1,
          ability: { guid: SPELLS.REJUVENATION.id },
          type: EventType.Heal,
        },
        {
          testid: 3,
        ...
        },
        {
          ...
          timestamp: 0,
          sourceID: 1,
          ability: { guid: SPELLS.REJUVENATION_GERMINATION.id },
          type: EventType.Heal,
        },
      ],
      result: [2, 3, 1, 4],
