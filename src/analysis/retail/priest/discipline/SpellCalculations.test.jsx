...
const calculateOverhealing = {};
const OffensivePenanceBoltEstimation = {};
const SmiteEstimation = {};
...
describe.skip('Overhealing Calculations', () => {
...
describe.skip('[PENANCE] Spell Calculations', () => {
...
describe.skip('[SMITE] Spell Calculations', () => {
  const fixtures = [
    {
      sins: 0,
      int: 100,
