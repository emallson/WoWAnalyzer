      ...
      <Statistic
        ...
        tooltip={
          <>
            Healing Breakdown:
            <ul>
              {this.atonementHealing > 0 && (
                <li>
                  {formatNumber(this.atonementHealing)} Atonement Healing (
                  {formatPercentage(
                    this.atonementOverHealing / (this.atonementOverHealing + this.atonementHealing),
                  )}{' '}
                  %OH)
                </li>
              )}
              <li>
                ...
                {formatPercentage(
                  this.directOverHealing / (this.directHealing + this.directOverHealing),
                )}{' '}
                %OH)
              </li>
