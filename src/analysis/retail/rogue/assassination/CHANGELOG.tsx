...
export default [
  ...
  change(date(2023, 1, 28), <>Update <SpellLink spell={TALENTS.EXSANGUINATE_TALENT} /> to check duration of <SpellLink spell={SPELLS.GARROTE} /> and <SpellLink spell={SPELLS.RUPTURE} />.</>, ToppleTheNun),
