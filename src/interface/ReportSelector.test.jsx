...
describe('ReportSelector', () => {
  ...
  test('getCode accepts base report url', () => {
    expect(getReportCode('https://www.warcraftlogs.com/reports/AB1CDEf2G3HIjk4L')).toBe(
      'AB1CDEf2G3HIjk4L',
    );
    expect(getReportCode('https://www.warcraftlogs.com/reports/AB1CDEf2G3HIjk4L/')).toBe(
      'AB1CDEf2G3HIjk4L',
  ...
  test('getCode accepts base anonymous report url', () => {
    expect(getReportCode('https://www.warcraftlogs.com/reports/a:AB1CDEf2G3HIjk4L')).toBe(
      'a:AB1CDEf2G3HIjk4L',
    );
    expect(getReportCode('https://www.warcraftlogs.com/reports/a:AB1CDEf2G3HIjk4L/')).toBe(
      'a:AB1CDEf2G3HIjk4L',
  ...
  test('getCode accepts full url with hashtag', () => {
    expect(
      getReportCode(
        'https://www.warcraftlogs.com/reports/AB1CDEf2G3HIjk4L#fight=6&type=healing&source=10',
      ),
    ).toBe('AB1CDEf2G3HIjk4L');
    expect(
      getReportCode(
        'https://www.warcraftlogs.com/reports/AB1CDEf2G3HIjk4L/#fight=6&type=healing&source=10',
      ),
  ...
  test('getCode accepts full anonymous url with hashtag', () => {
    expect(
      getReportCode(
        'https://www.warcraftlogs.com/reports/a:AB1CDEf2G3HIjk4L#fight=6&type=healing&source=10',
      ),
    ).toBe('a:AB1CDEf2G3HIjk4L');
    expect(
      getReportCode(
        'https://www.warcraftlogs.com/reports/a:AB1CDEf2G3HIjk4L/#fight=6&type=healing&source=10',
      ),
  ...
  test('getCode accepts localized urls', () => {
    expect(getReportCode('https://de.warcraftlogs.com/reports/AB1CDEf2G3HIjk4L')).toBe(
      'AB1CDEf2G3HIjk4L',
    );
    expect(getReportCode('https://kr.warcraftlogs.com/reports/AB1CDEf2G3HIjk4L/#fight=3')).toBe(
      'AB1CDEf2G3HIjk4L',
    );
  });
  test('getCode accepts localized anonymous urls', () => {
    expect(getReportCode('https://de.warcraftlogs.com/reports/a:AB1CDEf2G3HIjk4L')).toBe(
      'a:AB1CDEf2G3HIjk4L',
    );
    expect(getReportCode('https://kr.warcraftlogs.com/reports/a:AB1CDEf2G3HIjk4L/#fight=3')).toBe(
      'a:AB1CDEf2G3HIjk4L',
    );
  });
  test('getCode knows to only match the part between reports and #', () => {
    expect(
      getReportCode(
        'https://www.AAAAAAAAAAAAAAAA.com/reports/AB1CDEf2G3HIjk4L#fight=6&type=healing&source=10',
      ),
    ).toBe('AB1CDEf2G3HIjk4L');
    expect(
      getReportCode(
        'https://www.AAAAAAAAAAAAAAAA.com/reports/AB1CDEf2G3HIjk4L#fight=6&type=AAAAAAAAAAAAAAAA&source=10',
      ),
    ).toBe('AB1CDEf2G3HIjk4L');
  });
  test('getCode knows to only match the part between anonymous reports and #', () => {
    expect(
      getReportCode(
        'https://www.AAAAAAAAAAAAAAAA.com/reports/a:AB1CDEf2G3HIjk4L#fight=6&type=healing&source=10',
      ),
    ).toBe('a:AB1CDEf2G3HIjk4L');
    expect(
      getReportCode(
        'https://www.AAAAAAAAAAAAAAAA.com/reports/a:AB1CDEf2G3HIjk4L#fight=6&type=AAAAAAAAAAAAAAAA&source=10',
      ),
    ).toBe('a:AB1CDEf2G3HIjk4L');
  });
