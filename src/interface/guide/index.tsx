...
export const PerfectColor = globalThis.document
  ? getComputedStyle(document.documentElement).getPropertyValue('--guide-perfect-color')
  : undefined;
export const GoodColor = globalThis.document
  ? getComputedStyle(document.documentElement).getPropertyValue('--guide-good-color')
  : undefined;
export const OkColor = globalThis.document
  ? getComputedStyle(document.documentElement).getPropertyValue('--guide-ok-color')
  : undefined;
export const BadColor = globalThis.document
  ? getComputedStyle(document.documentElement).getPropertyValue('--guide-bad-color')
  : undefined;

// some extra colors for fun
export const VeryBadColor = globalThis.document
  ? getComputedStyle(document.documentElement).getPropertyValue('--guide-very-bad-color')
  : undefined;
export const MediocreColor = globalThis.document
  ? getComputedStyle(document.documentElement).getPropertyValue('--guide-mediocre-color')
  : undefined;
export const AvailableColor = globalThis.document
  ? getComputedStyle(document.documentElement).getPropertyValue('--guide-available-color')
  : undefined;
